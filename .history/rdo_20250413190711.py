...
def criar_rdo():
    ...
    if submit_button:
        ...
        # Processar e salvar o relatório aqui
        st.success(f"Relatório {numero_rdo} salvo com sucesso!")

    # Após o formulário - atualizar atividades se necessário
    if 'add_atividade' in st.session_state and st.session_state.add_atividade:
        ...
        # Recarregar a página para mostrar o novo campo
