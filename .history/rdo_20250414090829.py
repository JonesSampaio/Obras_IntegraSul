...
def carregar_obras():
    ...
    try:
        ...
        if not os.path.exists("data/obras.json"):
            # Criar arquivo com algumas obras de exemplo
            obras = {
                ...
                "Esc Est Ens Fun Décio Martins Costa": {
                    "data_inicio": "2024-02-01",
                    "prazo": "2024-11-30",
                    "etapa_atual": "Alvenaria",
                    "endereco": "Rua Principal, 123, Centro - Santa Cruz do Sul",
                    "rrt": "10748",
                    "responsavel_principal": "Eng. Pedro Santos",
                    "responsavel_acompanhamento": "Eng. Maria Lima",
                    "status": "Em andamento"
                },
                "Esc Est Ens Fun Dr Carlos Barbosa Gonçalves": {
                    "data_inicio": "2024-03-01",
                    "prazo": "2024-10-31",
                    "etapa_atual": "Estrutura",
                    "endereco": "Av. Central, 456, Centro - Cachoeira do Sul",
                    "rrt": "10749",
                    "responsavel_principal": "Eng. João Pereira",
                    "responsavel_acompanhamento": "Eng. Paula Costa",
                    "status": "Em andamento"
                }
            }
