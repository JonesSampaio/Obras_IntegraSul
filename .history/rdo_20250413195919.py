...
def salvar_rdo(obra, data_relatorio, clima_manha, clima_tarde, temperatura, 
    ...
    try:
        ...
        numero_rdo = obter_proximo_numero_rdo()
        ...
        with open('data/relatorios.json', 'w', encoding='utf-8') as file:
            json.dump(relatorios, file, ensure_ascii=False, indent=4)
...
def criar_rdo():
    ...
    proximo_num_rdo = obter_proximo_numero_rdo()
